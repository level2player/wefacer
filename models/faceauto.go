...
func (faceAddAutoGenerated FaceAddAutoGenerated) makeFaceAddResponseContent() string {
	...
	for index, result := range faceAddAutoGenerated.Faces {
		...
		contentstr += "表情:" + convert.Get_faceadd_expression(result.Attributes.Emotion.Anger, result.Attributes.Emotion.Disgust, result.Attributes.Emotion.Fear, result.Attributes.Emotion.Happiness, result.Attributes.Emotion.Neutral, result.Attributes.Emotion.Sadness, result.Attributes.Emotion.Surprise) + "\n"
